...
[`@aws-sdk/client-lakeformation`](https://www.npmjs.com/package/@aws-sdk/client-lakeformation/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lakeformation@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PNmUNkemoba97wWSoknCwyWUp391/7zLos+UAPkOnDIDtaqRDQm3L+bRtYKA7gol
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-lakeformation": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lakeformation@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lakeformation@3.699.0/index.min.mjs": "sha384-PNmUNkemoba97wWSoknCwyWUp391/7zLos+UAPkOnDIDtaqRDQm3L+bRtYKA7gol"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-lakeformation/blob/refs/tags/3.699.0/LICENSE
```
