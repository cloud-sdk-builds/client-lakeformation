...
[`@aws-sdk/client-lakeformation`](https://www.npmjs.com/package/@aws-sdk/client-lakeformation/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lakeformation@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ErUVWgkaX94r5lC88juJeSFNlnZFnFlhaEvI1hHR0WraSZbpPqdm5l45MfiN9B1d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-lakeformation": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lakeformation@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-lakeformation@3.413.0/index.min.mjs": "sha384-ErUVWgkaX94r5lC88juJeSFNlnZFnFlhaEvI1hHR0WraSZbpPqdm5l45MfiN9B1d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-lakeformation/blob/refs/tags/3.413.0/LICENSE
```
